...
@frappe.whitelist()
def get_leads_journey(user: str | None = None, page: int = 1, status: str | None = None):
	page = int(page)
	page_size = 20
	...
	qualified = frappe.db.count("CRM Lead", filters={"status": "Qualified", "converted": 0})
	converted = frappe.db.count("CRM Lead", filters={"converted": 1})
